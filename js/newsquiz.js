...
(function($) {
    ...
    function make_default_how_you_did_html(nCorrect, nQuestions) {
        var answersWord = nCorrect === 1 ? 'r&eacuteponse correcte' : 'r&eacuteponses correctes';

        return 'Vous avez trouv&eacute; <span class="correct_answers">' + nCorrect + '</span> ' +
               answersWord + ' sur ' + nQuestions + ' questions';
    }
